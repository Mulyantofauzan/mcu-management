...
function generateRujukanHTML(employee, mcu) {
  ...
  return `
    ...
    <div class="border-t border-black mt-4"></div>
        ...
        <!-- SURAT RUJUKAN -->
        <h2 style="text-align: center; font-weight: 600; text-decoration: underline; font-size: 13px; margin: 3px 0;">SURAT RUJUKAN</h2>
        ...
        <div style="font-size: 13px; line-height: 1.45;">
          ...
          <p style="margin: 0 0 3px 0; line-height: 1.3;">Mohon perawatan lebih lanjut pasien tersebut di bawah ini:</p>
          ...
          <div style="margin: 4px 0;">
            <p style="margin: 2px 0 2px 0; font-weight: 600;">Pemeriksaan Fisik:</p>
            <p style="margin: 2px 0; margin-left: 20px;">Tekanan Darah: <span style="border-bottom: 1px dotted #666; display: inline-block; width: 80px;">${mcu.bloodPressure || ''}</span> mmHg &nbsp; RR: <span style="border-bottom: 1px dotted #666; display: inline-block; width: 50px;">${mcu.respiratoryRate || ''}</span> /m</p>
            <p style="margin: 2px 0; margin-left: 20px;">Nadi: <span style="border-bottom: 1px dotted #666; display: inline-block; width: 70px;">${mcu.pulse || ''}</span> /m &nbsp; Suhu: <span style="border-bottom: 1px dotted #666; display: inline-block; width: 70px;">${mcu.temperature || ''}</span> °C</p>
          </div>

          <div style="margin: 4px 0;">
            <p style="margin: 3px 0;">Keluhan Utama: <span style="border-bottom: 1px dotted #666; display: inline-block; width: 430px;">${mcu.keluhanUtama || ''}</span></p>
            <p style="margin: 3px 0;">Diagnosis Kerja: <span style="border-bottom: 1px dotted #666; display: inline-block; width: 430px;">${mcu.diagnosisKerja || ''}</span></p>
            <p style="margin: 3px 0;">Alasan dirujuk: <span style="border-bottom: 1px dotted #666; display: inline-block; width: 430px;">${mcu.alasanRujuk || ''}</span></p>
          </div>
        ...
        <hr style="border: none; border-top: 1px solid #999; margin: 3px 0;">

        <!-- SURAT RUJUKAN BALIK -->
        <h2 style="text-align: center; font-weight: 600; text-decoration: underline; font-size: 13px; margin: 3px 0;">SURAT RUJUKAN BALIK</h2>

        <div style="font-size: 13px; line-height: 1.45;">
          <p style="margin: 2px 0;">Yang Terhormat Rekan Sejawat,</p>
          <p style="margin: 0 0 2px 0;">Bersama ini kami kirim kembali pasien dengan data sebagai berikut:</p>
        ...
        <!-- Peringatan -->
        <div style="border: 1px solid #ccc; background-color: #fffacd; padding: 6px; font-size: 12px; line-height: 1.35; margin-top: 3px;">
