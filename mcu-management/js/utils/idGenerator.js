...
export function generateDoctorId() {
  // For IndexedDB only - Supabase uses SERIAL auto-increment
  // Generate simple sequential ID by getting max ID from IndexedDB
  // This is a temporary ID that will be replaced by auto-increment from Supabase
  return null;  // Will be auto-generated by Supabase
}
